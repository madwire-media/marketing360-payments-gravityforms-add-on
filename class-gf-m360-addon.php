...
class GF_M360_AddOn extends GFPaymentAddOn
{
    ...
    public function settings_api_connection_check($field)
    {
        ...
        <div id="gf-m360-notice-box">
            <?php if ($details): ?>
                <p><?php echo sprintf(__('Currently connected to Marketing 360® account: %s %s. ', 'gravityformsm360'), esc_html($details->externalAccountNumber), esc_html($details->displayName)); ?><a
